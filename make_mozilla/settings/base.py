...
BSD_EVENT_JSON_FEED_URLS = (
    ('hack_jam', 'https://sendto.mozilla.org/page/event/search_results?format=json&wrap=no&orderby[0]=date&orderby[1]=desc&event_type=2&mime=application/json&limit=500&country=*'),
    ('kitchen_table', 'https://sendto.mozilla.org/page/event/search_results?format=json&wrap=no&orderby[0]=date&orderby[1]=desc&event_type=1&mime=application/json&limit=500&country=*'),
    ('pop_up', 'https://sendto.mozilla.org/page/event/search_results?format=json&wrap=no&orderby[0]=date&orderby[1]=desc&event_type=3&mime=application/json&limit=500&country=*'),
)
